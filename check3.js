        ...
        window.appData = {
            ...
            renderGallery() {
                ...
                const proj = this.projects.find(p => p.id === this.currentProjectId);
                // Safely convert items to an array whether Firebase returns Array or Object
                const itemsList = proj && proj.items
                    ? (Array.isArray(proj.items) ? proj.items : Object.values(proj.items))
                    : [];
